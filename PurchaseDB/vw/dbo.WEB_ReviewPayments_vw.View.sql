USE [PurchaseDB]
GO
/****** Object:  View [dbo].[WEB_ReviewPayments_vw]    Script Date: 29.01.2022 8:11:56 ******/
SET ANSI_NULLS ON
GO
...
SELECT        s.TID, s.OrderID, o.SubdivisionID, o.Login AS Author, d.Name AS Subdivision, o.Article, o.Currency AS OrderCurrency, o.Total AS OrderTotal, s.PaymentID, s.Login, p.Name AS Purpose, c.Name AS Seller, 
                         s.PaymentDate, s.Total, s.Total * s.Rate AS TotalRub, s.Tax, s.Status, s.Currency, s.Rate, s.Comment, o.MD, s.RD
FROM            dbo.Payments_tb AS s INNER JOIN
                         ...
                         ProvisionDB.dbo.DIC_Sellers_tb AS c ON c.TID = o.SellerID
