USE [ProvisionDB]
GO
/****** Object:  View [dbo].[WEB_Schedule_vw]    Script Date: 29.01.2022 7:30:47 ******/
SET ANSI_NULLS ON
GO
...
SELECT        o.TID AS OrderID, o.Author, o.Price, o.Status AS OrderStatus, o.RD AS RegistryDate, r.TID AS ReviewID, r.Login AS Reviewer, r.Status AS ReviewStatus, d.Created, d.Approved, d.Paid, d.Delivered, 
                         d.ReviewDueDate, d.FinishDueDate, d.AuditDate, d.Validated, o.CategoryID, o.SubdivisionID, o.SubdivisionCode, o.StockListID, o.MD, r.RD AS StatusDate
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         Or = 1350
         Or = 1350
         Or = 1' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'WEB_Schedule_vw'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=2 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'WEB_Schedule_vw'
GO
