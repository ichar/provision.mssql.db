...
--
--  v1.1: [ProvisionDB].[dbo].[WEB_ReviewerOrders_vw]
--
...
--
--  v2: [ProvisionDB].[dbo].[WEB_Reviews_vw]
--
...
--
--  v3: [ProvisionDB].[dbo].[WEB_Subdivisions_vw]
--
...
--
--  v5: [ProvisionDB].[dbo].[WEB_Conditions_vw]
--
...
--
--  v6: [ProvisionDB].[dbo].[WEB_Equipments_vw]
--
...
--
--  v7: [ProvisionDB].[dbo].[WEB_Params_vw]
--
...
--
--  v8: [ProvisionDB].[dbo].[WEB_Payments_vw]
--
...
--
--  v9: [ProvisionDB].[dbo].[WEB_Comments_vw]
--
...
--
--  v9.1: [ProvisionDB].[dbo].[WEB_OrderComments_vw]
--
...
--
--  v10: [ProvisionDB].[dbo].[WEB_OrderItems_vw]
--
...
--
--  v10.1: [ProvisionDB].[dbo].[WEB_OrderVendors_vw]
--
...
--
--  v11: [ProvisionDB].[dbo].[WEB_Authors_vw]
--
...
--
--  v13: [ProvisionDB].[dbo].[WEB_OrderChanges_vw]
--
...
SELECT
    ...
    c.RD
FROM
    [ProvisionDB].dbo.OrderChanges_tb AS c
    --INNER JOIN dbo.Orders_tb as o ON o.TID=c.OrderID

--
--  v14: [ProvisionDB].[dbo].[WEB_Categories_vw]
--
...
--
--  v16.1: [ProvisionDB].[dbo].[WEB_StocksChildren_vw]
--
...
--
--  v17: [ProvisionDB].[dbo].[WEB_Vendors_vw]
--
...
--
--  v18: [ProvisionDB].[dbo].[BATCH_Sellers_vw]
--
...
--
--  v20: [ProvisionDB].[dbo].[WEB_OrderRefers_vw]
--
...
--
--  v23: [ProvisionDB].[dbo].[WEB_Companies_vw]
--
