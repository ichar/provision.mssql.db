USE [ProvisionDB]
GO
/****** Object:  StoredProcedure [dbo].[UPDATE_Order_sp]    Script Date: 04/25/2021 01:45:58 ******/
...
GO
/****** Object:  View [dbo].[WEB_Orders_vw]    Script Date: 04/25/2021 01:45:46 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[WEB_Orders_vw]'))
DROP VIEW [dbo].[WEB_Orders_vw]
GO
/****** Object:  StoredProcedure [dbo].[REGISTER_Order_sp]    Script Date: 04/25/2021 01:45:58 ******/
...
GO
/****** Object:  StoredProcedure [dbo].[ADD_Param_sp]    Script Date: 04/25/2021 01:45:58 ******/
...
GO
/****** Object:  UserDefinedFunction [dbo].[CHECK_IsFloatEqual_fn]    Script Date: 04/25/2021 01:46:00 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[CHECK_IsFloatEqual_fn]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
DROP FUNCTION [dbo].[CHECK_IsFloatEqual_fn]
GO
/****** Object:  UserDefinedFunction [dbo].[CHECK_IsFloatEqual_fn]    Script Date: 04/25/2021 01:46:00 ******/
SET ANSI_NULLS ON
GO
...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[CHECK_IsFloatEqual_fn]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
BEGIN
...
AS
SELECT     o.TID, o.Login AS Author, o.Article, o.Qty, o.Purpose, o.Price, o.Currency, o.Total, o.Tax, p.Name AS Subdivision, u.Name AS Sector, e.Title AS Equipment, 
                      e.Name AS EquipmentName, c.Name AS Condition, s.Name AS Seller, s.Code AS SellerCode, s.Type AS SellerType, s.Title AS SellerTitle, s.Address AS SellerAddress, 
                      s.Contact AS SellerContact, s.URL AS SellerURL, g.Name AS Category, o.Account, o.URL, o.Status,
                          (SELECT     TOP (1) Status
