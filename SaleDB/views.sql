...
--
--  v1.1: [SaleDB].[dbo].[WEB_ReviewerOrders_vw]
--
...
--
--  v1.2: [SaleDB].[dbo].[WEB_CostOrders_vw]
--
...
--
--  v3: [SaleDB].[dbo].[WEB_Subdivisions_vw]
--
...
--
--  v5: [SaleDB].[dbo].[WEB_Conditions_vw]
--
...
--
--  v6: [SaleDB].[dbo].[WEB_Equipments_vw]
--
...
--
--  v7.1: [SaleDB].[dbo].[WEB_OrderParams_vw]
--
...
--
--  v8.1: [SaleDB].[dbo].[WEB_OrderPayments_vw]
--
...
--
--  v8.2: [SaleDB].[dbo].[WEB_ReviewPayments_vw]
--
...
--
--  v9.1: [SaleDB].[dbo].[WEB_OrderComments_vw]
--
...
--
--  v10: [SaleDB].[dbo].[WEB_OrderItems_vw]
--
...
--
--  v10.1: [SaleDB].[dbo].[WEB_OrderVendors_vw]
--
...
--
--  v13: [SaleDB].[dbo].[WEB_OrderChanges_vw]
--
...
SELECT
    ...
    c.RD
FROM
    [SaleDB].dbo.OrderChanges_tb AS c
    --INNER JOIN dbo.Orders_tb as o ON o.TID=c.OrderID

--
--  v14: [SaleDB].[dbo].[WEB_Categories_vw]
--
...
--
--  v15: [SaleDB].[dbo].[WEB_Schedule_vw]
--
...
--
--  v16.1: [SaleDB].[dbo].[WEB_StocksChildren_vw]
--
...
--
--  v18: [SaleDB].[dbo].[BATCH_Sellers_vw]
--
...
SELECT DISTINCT 
    ...
    s.Address
FROM 
	[SaleDB].[dbo].[DIC_Sellers_tb] as s
	LEFT OUTER JOIN [SaleDB].dbo.Orders_tb AS o ON s.TID=o.SellerID
GROUP BY s.TID, s.Name, s.Title, s.Address

--
--  v19: [SaleDB].[dbo].[WEB_Links_vw]
--
...
--
--  v20: [SaleDB].[dbo].[WEB_OrderRefers_vw]
--
...
--
--  v22: [SaleDB].[dbo].[WEB_ParamValues_vw]
--
...
--
--  v23: [SaleDB].[dbo].[WEB_Companies_vw]
--
...
--
--  v24: [SaleDB].[dbo].[WEB_Activities_vw]
--
