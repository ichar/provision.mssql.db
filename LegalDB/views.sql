...
--
--  v1.1: [LegalDB].[dbo].[WEB_ReviewerOrders_vw]
--
...
--
--  v1.2: [LegalDB].[dbo].[WEB_CostOrders_vw]
--
...
--
--  v2.1: [LegalDB].[dbo].[WEB_Decrees_vw]
--
...
--
--  v3: [LegalDB].[dbo].[WEB_Subdivisions_vw]
--
...
--
--  v5: [LegalDB].[dbo].[WEB_Conditions_vw]
--
...
--
--  v6: [LegalDB].[dbo].[WEB_Equipments_vw]
--
...
--
--  v7.1: [LegalDB].[dbo].[WEB_OrderParams_vw]
--
...
--
--  v8: [LegalDB].[dbo].[WEB_Payments_vw]
--
...
--
--  v8.1: [LegalDB].[dbo].[WEB_OrderPayments_vw]
--
...
--
--  v8.2: [LegalDB].[dbo].[WEB_ReviewPayments_vw]
--
...
--
--  v9: [LegalDB].[dbo].[WEB_Comments_vw]
--
...
--
--  v9.1: [LegalDB].[dbo].[WEB_OrderComments_vw]
--
...
--
--  v10: [LegalDB].[dbo].[WEB_OrderItems_vw]
--
...
--
--  v10.1: [LegalDB].[dbo].[WEB_OrderVendors_vw]
--
...
--
--  v11: [LegalDB].[dbo].[WEB_Authors_vw]
--
...
--
--  v13: [LegalDB].[dbo].[WEB_OrderChanges_vw]
--
...
SELECT
    ...
    c.RD
FROM
    [LegalDB].dbo.OrderChanges_tb AS c
    --INNER JOIN dbo.Orders_tb as o ON o.TID=c.OrderID

--
--  v14: [LegalDB].[dbo].[WEB_Categories_vw]
--
...
--
--  v15: [LegalDB].[dbo].[WEB_Schedule_vw]
--
...
--
--  v16.1: [LegalDB].[dbo].[WEB_StocksChildren_vw]
--
...
--
--  v17: [LegalDB].[dbo].[WEB_Vendors_vw]
--
...
--
--  v18: [LegalDB].[dbo].[BATCH_Sellers_vw]
--
...
SELECT DISTINCT 
    ...
    s.Address
FROM 
	[LegalDB].[dbo].[DIC_Sellers_tb] as s
	LEFT OUTER JOIN [LegalDB].dbo.Orders_tb AS o ON s.TID=o.SellerID
GROUP BY s.TID, s.Name, s.Title, s.Address

--
--  v19: [LegalDB].[dbo].[WEB_Links_vw]
--
...
--
--  v20: [LegalDB].[dbo].[WEB_OrderRefers_vw]
--
...
--
--  v21: [LegalDB].[dbo].[WEB_Sectors_vw]
--
...
--
--  v22: [LegalDB].[dbo].[WEB_ParamValues_vw]
--
...
--
--  v23: [LegalDB].[dbo].[WEB_Companies_vw]
--
...
--
--  v24: [LegalDB].[dbo].[WEB_Activities_vw]
--
