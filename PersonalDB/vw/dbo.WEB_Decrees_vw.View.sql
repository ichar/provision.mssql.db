USE [PersonalDB]
GO
/****** Object:  View [dbo].[WEB_Decrees_vw]    Script Date: 14.10.2021 10:53:59 ******/
SET ANSI_NULLS ON
GO
...
AS
SELECT        r.TID, r.OrderID, r.Login, r.Reviewer, r.Status, r.Note, r.MD, r.RegistryDate, r.StatusDate, d.TID AS DecreeID, d.Login AS Executor, d.Status AS DecreeStatus, d.DueDate, d.ReportID, d.RD
FROM            dbo.Decrees_tb AS d INNER JOIN
                         dbo.WEB_Reviews_vw AS r ON r.TID = d.ReviewID
