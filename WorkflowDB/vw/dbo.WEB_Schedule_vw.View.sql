USE [WorkflowDB]
GO
/****** Object:  View [dbo].[WEB_Schedule_vw]    Script Date: 30.03.2021 13:02:45 ******/
SET ANSI_NULLS ON
GO
...
AS
SELECT        o.TID AS OrderID, o.Author, o.Price, o.Status AS OrderStatus, o.RD AS RegistryDate, r.TID AS ReviewID, r.Login AS Reviewer, r.Status AS ReviewStatus, d.Created, d.Approved, d.Paid, d.Delivered, d.ReviewDueDate, 
                         o.CategoryID, o.SubdivisionID, o.SubdivisionCode, o.MD, r.RD AS StatusDate
