...
FROM
    dbo.Orders_tb as o
    LEFT OUTER JOIN dbo.DIC_Activities_tb AS a ON a.TID=o.ActivityID
    ...
    LEFT OUTER JOIN dbo.DIC_StockList_tb AS l ON l.TID=o.StockListID
    LEFT OUTER JOIN dbo.OrderDates_tb AS d ON d.OrderID=o.TID

--
--  v1.1: [WorkflowDB].[dbo].[WEB_ReviewerOrders_vw]
--
...
--
--  v1.2: [WorkflowDB].[dbo].[WEB_CostOrders_vw]
--
...
FROM
    ...
    LEFT OUTER JOIN dbo.DIC_Sellers_tb AS s ON s.TID=o.SellerID
    LEFT OUTER JOIN dbo.DIC_Categories_tb AS g ON g.TID=o.CategoryID
    LEFT OUTER JOIN dbo.DIC_StockList_tb AS l ON l.TID=o.StockListID
    LEFT OUTER JOIN dbo.OrderDates_tb AS d ON d.OrderID=o.TID

--
--  v2: [WorkflowDB].[dbo].[WEB_Reviews_vw]
--
...
--
--  v3: [WorkflowDB].[dbo].[WEB_Subdivisions_vw]
--
...
--
--  v4: [WorkflowDB].[dbo].[WEB_Sellers_vw]
--
...
--
--  v6: [WorkflowDB].[dbo].[WEB_Equipments_vw]
--
...
--
--  v7: [WorkflowDB].[dbo].[WEB_Params_vw]
--
...
--
--  v7.1: [WorkflowDB].[dbo].[WEB_OrderParams_vw]
--
...
--
--  v8: [WorkflowDB].[dbo].[WEB_Payments_vw]
--
...
--
--  v8.1: [WorkflowDB].[dbo].[WEB_OrderPayments_vw]
--
...
--
--  v8.2: [WorkflowDB].[dbo].[WEB_ReviewPayments_vw]
--
...
FROM
    ...
    LEFT OUTER JOIN dbo.DIC_Sellers_tb AS c ON c.TID=o.SellerID

--
--  v9: [WorkflowDB].[dbo].[WEB_Comments_vw]
--
...
--
--  v9.1: [WorkflowDB].[dbo].[WEB_OrderComments_vw]
--
...
--
--  v10: [WorkflowDB].[dbo].[WEB_OrderItems_vw]
--
...
--
--  v10.1: [WorkflowDB].[dbo].[WEB_OrderVendors_vw]
--
...
--
--  v11: [WorkflowDB].[dbo].[WEB_Authors_vw]
--
...
--
--  v13: [WorkflowDB].[dbo].[WEB_OrderChanges_vw]
--
...
SELECT
    ...
    c.RD
FROM
    [WorkflowDB].dbo.OrderChanges_tb AS c
    --INNER JOIN dbo.Orders_tb as o ON o.TID=c.OrderID

--
--  v14: [WorkflowDB].[dbo].[WEB_Categories_vw]
--
...
--
--  v15: [WorkflowDB].[dbo].[WEB_Schedule_vw]
--
...
--
--  v16: [WorkflowDB].[dbo].[WEB_Stocks_vw]
--
...
--
--  v16.1: [WorkflowDB].[dbo].[WEB_StocksChildren_vw]
--
...
--
--  v17: [WorkflowDB].[dbo].[WEB_Vendors_vw]
--
...
--
--  v18: [WorkflowDB].[dbo].[BATCH_Sellers_vw]
--
...
SELECT DISTINCT 
    ...
    s.Address
FROM 
	[WorkflowDB].[dbo].[DIC_Sellers_tb] as s
	LEFT OUTER JOIN [WorkflowDB].dbo.Orders_tb AS o ON s.TID=o.SellerID
GROUP BY s.TID, s.Name, s.Title, s.Address

--
--  v19: [WorkflowDB].[dbo].[WEB_Links_vw]
--
...
--
--  v20: [WorkflowDB].[dbo].[WEB_OrderRefers_vw]
--
...
--
--  v21: [WorkflowDB].[dbo].[WEB_Sectors_vw]
--
...
--
--  v22: [WorkflowDB].[dbo].[WEB_ParamValues_vw]
--
...
--
--  v23: [WorkflowDB].[dbo].[WEB_Companies_vw]
--
...
--
--  v24: [WorkflowDB].[dbo].[WEB_Activities_vw]
--
