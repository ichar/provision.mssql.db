...
GO
/****** Object:  StoredProcedure [dbo].[SET_OrderFacsimile_sp]    Script Date: 25.11.2021 16:11:29 ******/
DROP PROCEDURE IF EXISTS [dbo].[SET_OrderFacsimile_sp]
GO
/****** Object:  StoredProcedure [dbo].[REGISTER_Review_sp]    Script Date: 25.11.2021 16:11:29 ******/
DROP PROCEDURE IF EXISTS [dbo].[REGISTER_Review_sp]
GO
/****** Object:  View [dbo].[WEB_Orders_vw]    Script Date: 25.11.2021 16:11:29 ******/
DROP VIEW IF EXISTS [dbo].[WEB_Orders_vw]
GO
/****** Object:  View [dbo].[WEB_Decrees_vw]    Script Date: 25.11.2021 16:11:29 ******/
...
SELECT        o.TID, o.ActivityID, o.SubdivisionID, o.EquipmentID, o.CategoryID, o.StockListID, o.Login AS Author, o.Account, o.Article, o.Purpose,
                         ...
                         AS UnreadByLogin, o.EditedBy, d.Created, d.Approved, d.ReviewDueDate, d.FinishDueDate, d.Facsimile, o.MD, o.RD
